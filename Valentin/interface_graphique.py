...
class GameGrid(Frame):
    ...
    def init_matrix(self):
        self.matrix = create_grid(4)

        self.matrix=grid_add_new_tile(self.matrix)
        self.matrix=grid_add_new_tile(self.matrix)
    ...
    def key_down(self, event):
        ...
        if key in self.commands and move_correspondance[key] in move_possible(self.matrix):
            ...
            if 1==1:
                ...
                if is_game_over(self.matrix)== True:
                    self.grid_cells[1][1].configure(text="You",bg=BACKGROUND_COLOR_CELL_EMPTY)
