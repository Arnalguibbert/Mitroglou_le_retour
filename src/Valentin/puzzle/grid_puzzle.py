...
def init_game(GRID_LEN): #fictive arg
    ...
    for k in range(0,30): #on fait 20 mouvements aléatoires en évitant de faire 2 fois le même
        ...
        while mouvement == last_mouvement or not move_possible(game_grid,mouvement): #il y a toujours une possibilité car il y a toujours 2 mouvements possibles au min
            mouvement = rd.choice(["update_grid_up","update_grid_down","update_grid_left","update_grid_right"])
